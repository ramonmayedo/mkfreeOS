...
int Cfat::commandFile(int acommand, char *astring, u32 asize, u32 aptr) {
    ...
    switch (acommand) {
        ...
        case SEEK_CUR_FILE: return setPosFile(size);
        case SEEK_SET_FILE: return setPosFile(size);
        case SEEK_END_FILE: return setPosFile(size);
        case GET_NEXT_FILE:
        {
...
u32 Cfat::setPosFile(u32 apos) {
    ...
    if (scommand == SEEK_CUR_FILE) {
        ...
        pos = fileCurrent->fileBody.indexFile;

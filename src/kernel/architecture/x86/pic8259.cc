...
void Cpic8259::initialize() {
         ...
         */
	x86.port.outb(maps.picMap.master.regBase, 0x11); //Master ICW1
        /*Segundo 8259A en cascada igual palabra de control que el anterior*/
	x86.port.outb(maps.picMap.slave.regBase, 0x11);
	...
	// Initialization of ICW2
         ...
         */
	x86.port.outb(maps.picMap.master.regControl, 0x20);	// start vector = 32 
        /*Master 2 vector empieza en 0x70 */
	x86.port.outb(maps.picMap.slave.regControl, 0x28);	// start vector = 7-15 
	...
	// Initialization of ICW3 Indica donde esta conectado el escalvo con el amo 
         ...
         */
	x86.port.outb(maps.picMap.master.regControl, 0x04);
        
        /*Esclvo envia por la linea IRQ2 */
	x86.port.outb(maps.picMap.slave.regControl, 0x02);
	...
	// Initialization of ICW4
         ...
         */
	x86.port.outb(maps.picMap.master.regControl, 0x01);
        /*igual que el anterior*/
	x86.port.outb(maps.picMap.slave.regControl, 0x01);
         ...
         */
	x86.port.outb(maps.picMap.master.regControl, 0x0);
        /*igual que el anterior*/
	x86.port.outb(maps.picMap.slave.regControl, 0x0);
...
void Cpic8259::reconocer() {
    x86.port.outb(maps.picMap.master.regBase, 0x20);
    x86.port.outb(maps.picMap.slave.regBase, 0x20);
}
